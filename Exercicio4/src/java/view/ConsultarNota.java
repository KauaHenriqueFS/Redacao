...
public class ConsultarNota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            nota = Double.parseDouble(request.getParameter("txtNota"));

            dao = new DAOJPA();
            lista = dao.listarNota(nota);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Erro - Servelet ConsultarNota</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Erro no ConsultarNota at " + ex.getMessage() + "</h1>");
            out.println("</body>");
            out.println("</html>");            
        }
    }
