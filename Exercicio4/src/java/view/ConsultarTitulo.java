 ...
 * @author aluno
 */
@WebServlet(name = "ConsultarTitulo", urlPatterns = {"/ConsultarTitulo"})
public class ConsultarTitulo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Redações Cadastradas por Título</h1>");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Erro - Servlet ConsultarTitulo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Erro no ConsultarTitulo " + ex.getMessage() + "</h1>");
            out.println("</body>");
            out.println("</html>");            
        }
    }
